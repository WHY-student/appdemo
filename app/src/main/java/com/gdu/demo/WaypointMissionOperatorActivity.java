        ...
        if (product == null || !product.isConnected()) {
            ...
            mGDUFlightController.setStateCallback(new FlightControllerState.Callback() {
                ...
                public void onUpdate(FlightControllerState flightControllerState) {
                    ...
                    showText(horizenDis, String.format("%f",dis));
                    showText(vercalDis, String.format("%f",hei));
                    showText(horizenV, String.format("%f",ver));
                    showText(vercalV, String.format("%f",z_ver));
                }
            });
