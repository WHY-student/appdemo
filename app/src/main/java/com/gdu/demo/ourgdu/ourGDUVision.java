...
public class ourGDUVision {
    ...
    public ourGDUVision() {
        SocketCallBack3 var1;
        SocketCallBack3 var10013 = var1 = new SocketCallBack3() {
            {
                this.this$0 = var1;
            }

            public void callBack(byte var1, GduFrame3 var2) {
                byte[] var4;
                if (var2 != null && (var4 = var2.frameContent) != null) {
                    try {
                        com.gdu.demo.ourgdu.ourGDUVision.getDetectTargetNew(this.this$0, var4);
                    } catch (Exception var3) {
                        Log.i("获取监测目标出错", var3.toString());
                    }
                }
        ...
        var10013.<init>();
        this.targetDetectCallBack = var10013;
        SocketCallBack3 var2;
        this.videoTrackCallback = var2 = (var1x, var2x) -> {
            byte[] var5;
            if ((var5 = var2x.frameContent) != null) {
                com.gdu.sdk.vision.GDUVision var10000 = this;
                short var4 = var5[0];
                var1x = ByteUtilsLowBefore.byte2short(var5, 1);
                byte var10001 = (byte)var4;
                GduFrame3 var10002 = var2x;
                var4 = ByteUtilsLowBefore.byte2short(var2x.frameContent, 3);
                short var6 = ByteUtilsLowBefore.byte2short(var2x.frameContent, 5);
                short var3 = ByteUtilsLowBefore.byte2short(var10002.frameContent, 7);
                var10000.getTrackResult(var10001, var1x, var4, var6, var3);
            }
        };
        SocketCallBack3 var3;
        SocketCallBack3 var10010 = var3 = new SocketCallBack3() {
            {
                this.this$0 = var1;
            }
            ...
            public void callBack(byte var1, GduFrame3 var2) {
                byte[] var7;
                byte var8;
                if (var1 == 0 && var2 != null && (var7 = var2.frameContent) != null && (var8 = var7[0]) != 33) {
                    if (var8 == 32) {
                        com.gdu.sdk.vision.GDUVision.access$100(this.this$0, var7);
                    } else {
                        short var3 = 0;
                        short var4 = 0;
                        short var5 = 0;
                        short var6 = 0;
                        if (var7.length >= 9) {
                            var3 = (short)((int)((double)((var7[1] & 255) * 1920) / 255.0));
                            var4 = (short)((int)((double)((var7[2] & 255) * 1080) / 255.0));
                            var5 = (short)((int)((double)((var7[3] & 255) * 1920) / 255.0));
                            var6 = (short)((int)((double)((var7[4] & 255) * 1080) / 255.0));
                        }

                        com.gdu.sdk.vision.GDUVision.access$200(this.this$0, var8, var3, var4, var5, var6);
                    }
                }
        ...
        var10010.<init>();
        this.multipleTargetTrackCb = var10010;
        this.mGduCommunication3 = GduSocketManager.getInstance().getCommunication();
        this.mTargetModeList = new ArrayList();
        this.mGduCommunication3.addCycleACKCB(16908309, var1);
        this.mGduCommunication3.addCycleACKCB(49283093, var1);
        this.mGduCommunication3.addCycleACKCB(33555224, var1);
        this.mGduCommunication3.addCycleACKCB(16908304, var2);
        this.mGduCommunication3.addCycleACKCB(49283088, var2);
        this.mGduCommunication3.addCycleACKCB(16908305, var3);
        this.mGduCommunication3.addCycleACKCB(49283089, var3);
    }
    ...
    private void getDetectTargetNew(byte[] var1) {
        ...
        if ((var2 = var1.length) >= 3) {
            ...
            var5 = new CopyOnWriteArrayList.<init>();
    ...
    private TargetMode parseTargetModeNew(byte[] var1) {
        TargetMode var6;
        TargetMode var10000 = var6 = new TargetMode;
        byte[] var10007 = var1;
        byte[] var10008 = var1;
        byte[] var10009 = var1;
        byte[] var10010 = var1;
    ...
    private TargetMode parseMultiTargetModeNew(byte[] var1) {
        TargetMode var9;
        TargetMode var10000 = var9 = new TargetMode;
        byte[] var10011 = var1;
        byte[] var10012 = var1;
        byte[] var10013 = var1;
        byte[] var10014 = var1;
